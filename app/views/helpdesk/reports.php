...
<script src="<?php echo URLROOT; ?>/public/datatables/jquery.dataTables.min.js"></script>
   ...
   <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="col-lg-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  <form action="<?php echo URLROOT; ?>/helpdesk/reports" method="post">                 
    ...
    <?php } ?>       
                  ...
                  <a href="<?php echo URLROOT; ?>/helpdesk/reports" style="margin-top: 30px;"  class="btn btn-info">  <i class="fa fa-undo" aria-hidden="true"></i></a>                 
                </div>
                 </form>
