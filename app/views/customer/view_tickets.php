              ...
              <div class="card">
                <div class="card-body">
                 ...
                 <tbody id="myTable">
                    ...
                    <td>  
                    <a href="<?php echo URLROOT; ?>/customer/open/<?php echo $tickets->ticketID; ?>"> <i class="menu-icon mdi mdi-eye" data-toggle="tooltip" title="View Ticket"> </i></a>
                    <a href="<?php echo URLROOT; ?>/helpdesk/status/<?php echo $tickets->ticketID; ?>"> <i class="menu-icon mdi mdi-elevation-rise" data-toggle="tooltip" title="View Ticket"> </i></a>                                                         
                    <a href="<?php echo URLROOT; ?>/customer/customer_accept/<?php echo $tickets->ticketID; ?>"  class="btn btn-success"> Accept </a>
                   </td>                     
                   </tr>                      
                   <?php
                     }
