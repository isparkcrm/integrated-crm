     ...
     <!-- <a href="show_tickets.php" class="btn btn-dark">More</a> -->
      ...
      if($data['attachment']==''){
       ...
       <?php
        ...
        ?>
         <p class="card-text">Attachment:<strong><?php echo $data['attachment']; ?> </strong>  <a href="<?php echo URLROOT; ?>/uploads/<?php echo $data['attachment']; ?>" style="padding-left: 10px;">Download</a>   </p>
         <?php
      }
     ?>
    </div>
