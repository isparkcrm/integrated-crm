				...
				<div class="panel-body">
					...
					<div style="    background: linear-gradient(45deg, #eac2c2, #e4e4e4)!important;">
					 Updates
						...
						<p> Customer Name: <strong><?php echo $leadhistory->customername;?> </strong> </p>
						<p>Product:<strong><?php echo $leadhistory->productname;?></strong></p>
						<p>Order Value:<strong><?php echo $leadhistory->ordervalue;?></strong></p>
						...
						<p>Next Action By:<strong><?php echo $leadhistory->nextactiondate;?></strong></p>
						<p>Updated At:<strong><?php echo $leadhistory->created_at;?></strong></p>
						  </div>
						  </div>
						  <?php endforeach;?>
					</div>
