           ...
           <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Customer Name<sup style="color:red;font-size:16px;">*</sup></label>
                          <div class="col-sm-9">
						  
						 <input type="text" readonly="readonly" name="email" value="<?php echo $data['name'];?>" class="form-control"/> 
						 </div>
                        </div>
                      </div>                    
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group row">
                          ...
                          <div class="col-sm-9">
							...
							<input type="text" readonly="readonly" name="email" value="<?php echo $data['email'];?>" class="form-control"/> 
						 </div>
                        </div>
                      </div>                    
                    </div>
