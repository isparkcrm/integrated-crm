				   ...
				   <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Close Date<sup style="color:red;font-size:16px;">*</sup></label>
                          <div class="col-sm-9">
						 <input type="Date" name="closedate" class="form-control"/> 
						 <span class="alert-danger"><?php echo $data['closedate_err']; ?></span>
						 </div>
                        </div>
                      </div>                    
                    </div>
					<div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Close Commit<sup style="color:red;font-size:16px;">*</sup></label>
                          <div class="col-sm-9">
						  <select class="form-control" name="closecommit">
						 ...
						 <span class="alert-danger"><?php echo $data['closecommit_err']; ?></span>
						 </div>
                        </div>
                      </div>                    
                    </div>
					<div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Closed Reason</label>
						  <div class="col-sm-9"  >
						   <textarea class="form-control" name="closereason" placeholder="Closed Reason" rows="4" cols="50"></textarea>
						    <span class="alert-danger"><?php echo $data['closereason_err']; ?></span>
                        </div>
                      </div>
                  </div>
				 </div>
