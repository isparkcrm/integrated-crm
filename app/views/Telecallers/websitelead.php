   ...
   <div class="col-12 grid-margin">
		...
		<div class="card-body">
			...
			<table class="table table-hover dataTable table-striped" id="example" style="width:100%">
               ...
               <tbody id="myTable">
			   <?php foreach($data['websitelead'] as $outbound):?>
			     <tr>
				 
				    <td><?php echo $outbound->customername;?></td>
                    <td><?php echo $outbound->mobile;?></td> 
                    <td><?php echo $outbound->email;?></td> 
                    <td><?php echo $outbound->customeraddress;?></td> 
                    <?php if($outbound->assignee=="Not Assignee") {?>					
                    <td><a href="<?php echo URLROOT;?>/telecaller/updatewebsitelead/<?php echo $outbound->id;?>" class="btn btn-primary" value="Assign">Assign to Me</a></td>
					...
					<td><a href="<?php echo URLROOT;?>/telecaller/websitesendemail/<?php echo $outbound->id;?>" class="mdi mdi-email-outline"></a>
						<a href="<?php echo URLROOT;?>/telecaller/websiteemailsend/<?php echo $outbound->id;?>" class="mdi mdi-email-open"></a>
					</td>
					<td><a href="<?php echo URLROOT;?>/telecaller/websitelead_master/<?php echo $outbound->id;?>" class="mdi mdi-account-star"></a></td>
				     <?php }?>					  
				   </tr> 
				   <?php endforeach;?>
				</tbody>
