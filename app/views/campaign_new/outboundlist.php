...
<div class="main-panel">
	...
	<div class="card">
	<div class="card-body">
		<h2 style="margin-left:35%;">Assigning Call List</h2>
			...
			<input disabled type="text" name="name" value="<?php echo $data['campaignname'];?>" id="name"/>
			</div>
			<div class="form-group row">
			<label class="col-sm-3 col-form-label">Name<sup>*</sup></label>
			<input disabled type="text" name="name" value="<?php echo $data['name'];?>" id="name"/>
			</div>
				<div class="form-group row">
			<label class="col-sm-3 col-form-label">Mobile<sup>*</sup></label>
			<input disabled type="text" name="mobile" value="<?php echo $data['mobile'];?>" id="mobile"/>
			</div>
			<div class="form-group row">
		...
		<table class="table table-hover dataTable table-striped" id="example" style="width:100%">
				...
				<?php foreach($data['outbound'] as $call) : ?>      
                 <tr>
					...
					<!--<//?php foreach($data['gethistory'] as $history) { if($history->outboundrow_id == $call->id ){ ?>
