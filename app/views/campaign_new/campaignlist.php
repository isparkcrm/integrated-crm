			...
			<div class="table-responsive">
			   ...
			   <tbody id="myTable">
                 ...
                 <tr>
					...
					<td>
					<form method="post" role="form" action="<?php echo URLROOT; ?>/Campaign/agent/<?php echo $campaign->campaignID; ?>">
					<div class="wrap"><input type="hidden" name="id" value="<?php echo $campaign->campaignID;?>">
					<button type="submit" id="submit" name="agent" value="Agent" class="btn btn-info">Agent</button> </div>
					</form>
					</td>
					<td>
				   <form method="post" role="form" action="<?php echo URLROOT; ?>/Campaign/addclient/<?php echo $campaign->campaignID; ?>">
					<div class="wrap"><input type="hidden" name="id" value="<?php echo $campaign->campaignID;?>">          
					<button type="submit" id="submit" name="client" value="client" class="btn btn-info">Client</button> </div>
					</form>
					</td>
					</div>
					<?php }?>
