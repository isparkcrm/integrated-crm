              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="addhead">Lead Drop</h4>                    
				   <form action="<?php echo URLROOT; ?>/leads/leadlost/<?php echo $data['id']; ?>" method="POST"  enctype="multipart/form-data">
				 ...
				 <div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Lost To Whom<sup style="color:red;font-size:16px;">*</sup></label>
                          <div class="col-sm-9">
						 <input type="text" name="losttowhom" class="form-control"/> 
						 <span class="alert-danger"><?php echo $data['losttowhom_err']; ?></span>
						 </div>
                        </div>
                      </div>                    
                    </div>
					<div class="row">
                      <div class="col-md-6">
                        <div class="form-group row">
                          <label class="col-sm-3 col-form-label">Lost Reason</label>
						  <div class="col-sm-9"  >
						   <textarea class="form-control" name="lostreason" placeholder="lostreason" rows="4" cols="50"></textarea>
						    <span class="alert-danger"><?php echo $data['lostreason_err']; ?></span>
                        </div>
                      </div>
                  </div>
				 </div>
