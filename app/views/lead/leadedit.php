              ...
              <div class="card">
                <div class="card-body">
                  <h4 class="addhead">Lead Information</h4>                    
				   <form action="<?php echo URLROOT;?>/leads/leadedit/<?php echo $data['id'];?>" method="POST"  enctype="multipart/form-data">
				   <div class="row">
                      <div class="col-md-6">
                    ...
                    <div class="row">
					 ...
					 <div class="col-md-6">
					  ...
					  <?php } else {?>
					  <div  class="form-group row" id="industryother">
						<label class="col-sm-3 col-form-label">Industy Others</label>
						<div  class="col-md-9">
						<input type="text" name="industryother" value="<?php echo $data['industryother'];?>" class="form-control" />
						</div>
						</div>
					  <?php }?>
						<div class="form-group row">
						...
						<label class="col-sm-3 col-form-label">Lead Source Others</label>
						<div   class="col-md-9">
						<input type="text" name="leadsourceother" value="<?php echo $data['leadsourceother'];?>" class="form-control" />
						</div>
						</div>
						</div>
						</div>					  
					...
					<div class="col-md-9">					 
					  ...
					  <option value="<?php echo $data['leadoem'];?>" selected="selected"><?php echo $data['leadoem'];?></option>
					    ...
					    <div class="col-md-6">
							<div class="form-group row">
								...
								<div style="display:none;" id="vertical1" class="col-md-9">
									<input type="text" name="verticalother" value="<?php echo $data['verticalother'];?>" class="form-control" />
								</div>
							</div>
						</div>
						<div  class="col-md-6">
						    <div class="form-group row">
								...
								<div style="display:none;" id="oem1" class="col-md-9">
									<input type="text" name="oemother" value="<?php echo $data['oemother'];?>" class="form-control" />
								</div>
							</div>
						</div>
					 </div>		
  ...
  <!-- ************************************************************************************************** -->
				...
				<div class="row">
					...
					<div class="col-md-9">					 
					  ...
					  <option value="<?php echo $data['leadowner'];?>" selected="selected"><?php echo $data['leadowner'];?></option>
