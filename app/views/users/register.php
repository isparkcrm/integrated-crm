      ...
      <div class="content-wrapper d-flex align-items-center auth register-bg-1 theme-one">
        <div class="row w-100">
          <div class="col-lg-4 mx-auto">
            <h2 class="text-center mb-4">Enter Details to Register</h2>
              ...
              <div class="contact-block"> 
                     ...
                     <hr />
                            <h5>Enter Details to Register</h5>
                                 ...
                                 <div class="form-group input-group">                                           
                                 <input type="number" class="form-control" name="number" placeholder="Contact Number"  required="required" />
                                    </div>
                                    
                                <div class="form-group input-group">
                                <select name="org_type"  id="org_type"  class="form-control">
                                <option disabled="" label="Select Organization Type." selected="" value=""> Select Organization Type..</option>
                                <option value="corporations">Corporations</option>
                                <option value="governments">Governments</option>
                                <option value="international organization">International Organizations</option>
                                ...
                                <option value="Company">Company</option>
                                    ...
                                    <div class="form-group input-group">                                           
                                            <input type="text" class="form-control" name="org" placeholder="Organization Name"  required="required" />
                                    </div>
                                    <div class="form-group input-group">                                        
                                      ...
                                      <div class="form-group input-group">                                       
                                        <input type="text" class="form-control"  name="gst" placeholder="GST Number"  required="required" />
                                        <input type="text" class="form-control"  name="gst_pan" placeholder="GST PAN Number"  required="required" />
                                    </div>
                                ...
                                <option value="sales and service ">Sales & Service</option>
                                ...
                                <option disabled="" label="Country" selected="" value="">Country</option>
                                 ...
                                 <option value="ZW">Zimbabwe</option></select>
                                    ...
                                    <input type="submit"  class="btn btn-success mr-2" value="Register">
