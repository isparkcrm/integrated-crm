...
<div class="main-panel">
		...
		<div class="col-12 grid-margin">
              <div class="card">
			   ...
			   <form action="<?php echo URLROOT; ?>/campaign/agentinsert" method="post">  			  
           ...
           <div class="table-responsive">
               ...
               <tbody>
                 ...
                 <tr>
                   ...
                   <td>
					<a href="<?php echo URLROOT; ?>/Campaign/agentdelete/<?php echo $agents->agent_id; ?>" class="btn btn-info">Remove</a></div>
				  </td>
